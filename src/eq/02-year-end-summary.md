...
年终总结写成了功能清单？汇报时满嘴技术术语领导听不懂？辛辛苦苦做了一年，绩效却只有C？问题不在你做了多少，而在你有没有把价值说清楚。
...
2. **只写执行不写思考**：写"完成了XX开发"不如写"通过分析XX问题，提出XX方案，效果XX"。复盘仅陈述事实无深度归因，等于浪费时间。
3. **不写失败和教训**：只报喜不报忧，隐藏问题直到爆发，领导最怕的不是问题，是"突然的惊吓"。主动写"今年最大的失误是XX，教训是XX"反而加分。
4. **没有未来规划**：只总结过去，不规划未来 = 没有上进心。至少要写3个明年改进项。
5. **汇报对象错位**：给技术领导讲业务、给业务领导讲架构，用技术术语轰炸非技术领导——大谈CAP定理、最终一致性，领导内心OS："说人话。"没有根据听众调整内容比重。
6. **把总结写成功能清单**：按月罗列功能、"写了XX个类、XX行代码"、周报写成代码变更记录——领导关心的是业务影响和价值，不是你的任务列表。
...
年终总结不是写你做了什么，而是写你创造了什么价值。你写年终总结时踩过哪些坑？评论区留言，我帮你针对性优化。
